...
const buildPlaneFromShape = (scene, points) => {
  ...
  for (let i = 2; i < points.length - 1; i += 2) {
    ...
    console.log("points", points[i], points[i + 1]);
  ...
  floor.rotation.x = -Math.PI / 2; // Rotate 90 degrees to lie on the XZ plane
...
export { initWallCreation, buildPlaneFromShape, buildWallFromLine };
